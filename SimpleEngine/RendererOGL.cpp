...
RendererOGL::RendererOGL() : window(nullptr), context(nullptr), spriteVertexArray(nullptr),
	...
	ambientLight(Vector3{ 1.0f, 1.0f, 1.0f }), dirLight({ Vector3::zero, Vector3::zero, Vector3::zero })
{
}
